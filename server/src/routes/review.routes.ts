...
reviews.post('/', auth, validate(reviewCreateSchema), asyncHandler(controller.save));
reviews.patch('/:id', auth, validate(idParamsSchema, 'params'), validate(reviewUpdateSchema), asyncHandler(controller.update));
reviews.delete('/:id', auth, validate(idParamsSchema, 'params'), asyncHandler(controller.remove));
